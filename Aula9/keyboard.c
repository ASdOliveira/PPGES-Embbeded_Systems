...
* mais simples. já que o valor recebido é sempre potência de 2... ao invés do switch case.
*************************************/
...
EKey_status decodKey(uint8_t count, uint8_t &value)
{
   ...
   if(columns != 0x00)  //se algo foi lido, haja vista que ler zero, é sinonimo de não terlido nada...
   {
